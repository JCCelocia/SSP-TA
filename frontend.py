...
from backend import (
    ...
    SanitizationEngine, get_available_kdf_methods
)
...
class DashboardFrame(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        title = ctk.CTkLabel(main_container, text="Security Toolkit Dashboard", 
    ...
    def _create_feature_card(self, parent, title, description, command):
        ...
        ctk.CTkLabel(card, text=title, font=ctk.CTkFont(size=20, weight="bold")).pack(pady=(20, 10))
        ctk.CTkLabel(card, text=description, font=ctk.CTkFont(size=12), 
                    text_color=("gray60", "gray40"), justify="center").pack(pady=(0, 20))
        
        ctk.CTkButton(card, text="Open", command=command, height=40, width=120).pack(pady=(0, 20))
        
        return card


class LocalSecurityFrame(ctk.CTkFrame):
    """Local Security features (MS2 features)"""
    ...
    def setup_ui(self):
        # Create tabview for local security tools
        self.tabview = ctk.CTkTabview(self, width=1100, height=700)
        self.tabview.pack(expand=True, fill="both", padx=20, pady=20)
        
        self.tabview.add("Network Traffic")
        self.tabview.add("Port Scanner")
        
        self.traffic_frame = NetworkTrafficFrame(self.tabview.tab("Network Traffic"))
        self.traffic_frame.pack(fill="both", expand=True)
        
        self.scanner_frame = PortScannerFrame(self.tabview.tab("Port Scanner"))
...
class NetworkTrafficFrame(ctk.CTkFrame):
    ...
    def setup_ui(self):
        title = ctk.CTkLabel(self, text="Network Traffic Analyzer", 
                           font=ctk.CTkFont(size=24, weight="bold"))
        title.pack(pady=(10, 5))
        
        warning = ctk.CTkLabel(self, 
                              text="⚠️ Requires admin/root privileges",
    ...
    def create_controls(self):
        ...
        iface_row.pack(pady=8)
        
        ctk.CTkLabel(iface_row, text="Interface:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        ...
        filter_row.pack(pady=8)
        
        ctk.CTkLabel(filter_row, text="Protocol:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        self.protocol_var = tk.StringVar(value="All")
        ctk.CTkOptionMenu(filter_row, variable=self.protocol_var,
                         values=["All", "TCP", "UDP", "ICMP"], width=80).pack(side="left", padx=5)
        
        ctk.CTkLabel(filter_row, text="Port:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        self.port_entry = ctk.CTkEntry(filter_row, width=60, placeholder_text="80")
        self.port_entry.pack(side="left", padx=5)
        
        ctk.CTkLabel(filter_row, text="Search:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        self.search_entry = ctk.CTkEntry(filter_row, width=180, textvariable=self.search_var)
        ...
        self.start_btn = ctk.CTkButton(btn_row, text="Start", command=self.start_capture,
                                      fg_color="green", width=80, height=30)
        self.start_btn.pack(side="left", padx=5)
        
        self.stop_btn = ctk.CTkButton(btn_row, text="Stop", command=self.stop_capture,
                                     fg_color="red", state="disabled", width=80, height=30)
        self.stop_btn.pack(side="left", padx=5)
        
        ctk.CTkButton(btn_row, text="Clear", command=self.clear_display, width=80, height=30).pack(side="left", padx=5)
    ...
    def create_status_section(self):
        ...
        self.status_label = ctk.CTkLabel(status_inner, text="Ready", font=ctk.CTkFont(size=11))
        self.status_label.pack(side="left")
        
        self.packet_count_label = ctk.CTkLabel(status_inner, text="Packets: 0", font=ctk.CTkFont(size=11, weight="bold"))
...
class PortScannerFrame(ctk.CTkFrame):
    ...
    def setup_ui(self):
        title = ctk.CTkLabel(self, text="Port Scanner", 
                           font=ctk.CTkFont(size=24, weight="bold"))
        title.pack(pady=(10, 5))
        
        warning = ctk.CTkLabel(self, text="⚠️ Only scan systems you own", 
                              text_color="orange", font=ctk.CTkFont(size=11))
        warning.pack(pady=(0, 15))
    ...
    def create_controls(self):
        ...
        ctk.CTkLabel(input_row, text="Target:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        self.target_entry = ctk.CTkEntry(input_row, width=120)
        self.target_entry.insert(0, "127.0.0.1")
        self.target_entry.pack(side="left", padx=5)
        
        ctk.CTkLabel(input_row, text="Start:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        self.start_port_entry = ctk.CTkEntry(input_row, width=60)
        self.start_port_entry.insert(0, "20")
        self.start_port_entry.pack(side="left", padx=5)
        
        ctk.CTkLabel(input_row, text="End:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        self.end_port_entry = ctk.CTkEntry(input_row, width=60)
        self.end_port_entry.insert(0, "1024")
        self.end_port_entry.pack(side="left", padx=5)
        
        ctk.CTkLabel(input_row, text="Timeout:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(10, 5))
        self.timeout_entry = ctk.CTkEntry(input_row, width=50)
        ...
        self.scan_btn = ctk.CTkButton(btn_row, text="Start Scan", command=self.start_scan,
                                     fg_color="green", width=90, height=30)
        ...
        ctk.CTkButton(btn_row, text="Clear", command=self.clear_results, width=80, height=30).pack(side="left", padx=5)
    ...
    def create_progress(self):
        ...
        self.status_scan_label = ctk.CTkLabel(progress_frame, text="Ready", font=ctk.CTkFont(size=11))
...
class WebSecurityFrame(ctk.CTkFrame):
    """Web Security features (MS1 features with improvements)"""
    ...
    def setup_ui(self):
        ...
        self.tabview.add("Password Strength")
        self.tabview.add("Password Generator")
        self.tabview.add("Form Validator")
        
        self.strength_frame = PasswordStrengthTab(self.tabview.tab("Password Strength"))
        self.strength_frame.pack(fill="both", expand=True)
        
        self.generator_frame = PasswordGeneratorTab(self.tabview.tab("Password Generator"))
        self.generator_frame.pack(fill="both", expand=True)
        
        self.validator_frame = FormValidatorTab(self.tabview.tab("Form Validator"))
...
class PasswordStrengthTab(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        self.strength_label = ctk.CTkLabel(self, text="Strength: Not Analyzed", 
                                          font=ctk.CTkFont(size=16, weight="bold"))
        self.strength_label.pack(pady=10)
        
        self.strength_bar = ctk.CTkProgressBar(self, width=400, height=15)
        self.strength_bar.pack(pady=10)
        self.strength_bar.set(0)
        
        self.feedback_text = ctk.CTkTextbox(self, height=150, width=500, font=ctk.CTkFont(size=11))
...
class PasswordGeneratorTab(ctk.CTkFrame):
    """Password Generator with Hash support"""
    ...
    def setup_ui(self):
        title = ctk.CTkLabel(self, text="Password Generator & Hasher", 
                           font=ctk.CTkFont(size=20, weight="bold"))
        title.pack(pady=(15, 10))
        
        # Info about sanitization and limits
        info_label = ctk.CTkLabel(self, 
                                 text="💡 Input sanitization enabled • Max 8KB per field • PBKDF2 default: 310,000 iterations",
        ...
        ctk.CTkLabel(left_frame, text="Generation Options", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=10)
        
        ctk.CTkLabel(left_frame, text="Length:", font=ctk.CTkFont(size=11)).pack(pady=5)
        self.length_var = tk.StringVar(value="12")
        ctk.CTkEntry(left_frame, textvariable=self.length_var, width=80).pack(pady=5)
        ...
        for var, text in [
            ...
            ctk.CTkCheckBox(left_frame, text=text, variable=var).pack(anchor="w", padx=20, pady=2)
        
        ctk.CTkButton(left_frame, text="Generate Password", 
                     command=self.generate_single, height=35).pack(pady=10)
        ctk.CTkButton(left_frame, text="Generate Multiple (5)", 
                     command=self.generate_multiple, height=30).pack(pady=5)
        
        # Hash Options
        ctk.CTkLabel(left_frame, text="Hash Options", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=(15, 5))
        
        ctk.CTkLabel(left_frame, text="KDF Method:", font=ctk.CTkFont(size=11)).pack(pady=5)
        self.kdf_var = tk.StringVar(value="pbkdf2")
        kdf_dropdown = ctk.CTkOptionMenu(left_frame, variable=self.kdf_var, 
                                        values=list(self.kdf_methods.keys()), width=150)
        kdf_dropdown.pack(pady=5)
        
        # Tooltip for KDF
        kdf_info = ctk.CTkLabel(left_frame, 
                               text="ℹ️ PBKDF2 recommended (NIST 2023)", 
                               font=ctk.CTkFont(size=9), text_color=("gray50", "gray50"))
        kdf_info.pack(pady=2)
        
        ctk.CTkLabel(left_frame, text="PBKDF2 Iterations:", font=ctk.CTkFont(size=11)).pack(pady=5)
        self.iterations_var = tk.StringVar(value="310000")
        self.iterations_entry = ctk.CTkEntry(left_frame, textvariable=self.iterations_var, width=100)
        ...
        ctk.CTkLabel(right_frame, text="Generated Passwords", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=10)
        
        self.password_text = ctk.CTkTextbox(right_frame, height=120, font=ctk.CTkFont(size=12))
        self.password_text.pack(fill="x", padx=10, pady=5)
        
        btn_frame = ctk.CTkFrame(right_frame, fg_color="transparent")
        btn_frame.pack(pady=5)
        
        ctk.CTkButton(btn_frame, text="Hash All", command=self.hash_passwords, 
                     width=100, height=28).pack(side="left", padx=5)
        ctk.CTkButton(btn_frame, text="Clear", command=self.clear_all, 
                     width=80, height=28).pack(side="left", padx=5)
        
        ctk.CTkLabel(right_frame, text="Hash Results", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=(10, 5))
        
        self.hash_text = ctk.CTkTextbox(right_frame, height=200, font=ctk.CTkFont(size=10))
        self.hash_text.pack(fill="both", expand=True, padx=10, pady=5)
    ...
    def generate_multiple(self):
        try:
            params = self.get_gen_params()
            passwords = self.generator.generate_multiple(5, **params)
            self.password_text.delete("1.0", "end")
            pwd_list = "\n".join(f"{i+1}. {pwd}" for i, pwd in enumerate(passwords))
            self.password_text.insert("1.0", pwd_list)
        except Exception as e:
            messagebox.showerror("Error", str(e))
    ...
    def hash_passwords(self):
        try:
            content = self.password_text.get("1.0", "end-1c").strip()
            if not content:
                messagebox.showwarning("Warning", "No passwords to hash")
                return
            
            # Extract passwords (handle numbered list or single password)
            passwords = []
            ...
            for i, pwd in enumerate(passwords, 1):
                result_dict = self.hasher.hash_passwords(
                    [pwd], 
                    method=kdf_method, 
                ...
                results.append(f"Password {i}: {pwd}")
                results.append(f"  KDF: {result['kdf']}")
                if 'iterations' in result:
                    results.append(f"  Iterations: {result['iterations']}")
                results.append(f"  Hash: {result['hash'][:64]}...")
                results.append("")
            
            self.hash_text.insert("1.0", "\n".join(results))
            
            # Log warning if iterations below threshold
            if kdf_method == 'pbkdf2' and iterations < 310000:
                messagebox.showwarning("Low Iterations", 
                    f"You used {iterations} iterations, which is below the recommended 310,000 (NIST 2023)")
        
        except Exception as e:
            messagebox.showerror("Error", f"Hashing error: {str(e)}")
...
class FormValidatorTab(ctk.CTkFrame):
    """Form Validator with Sanitization"""
    ...
    def setup_ui(self):
        title = ctk.CTkLabel(self, text="Form Validator & Sanitizer", 
                           font=ctk.CTkFont(size=20, weight="bold"))
        title.pack(pady=(15, 10))
        
        # Sanitization info
        info_label = ctk.CTkLabel(self, 
                                 text="🛡️ Automatic sanitization: XSS, SQLi patterns, CSRF checks • Input limit: 8KB",
                                 font=ctk.CTkFont(size=10), text_color=("gray50", "gray50"))
        info_label.pack(pady=5)
        ...
        ctk.CTkLabel(left_frame, text="Test Form", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=10)
        ...
        for label_text, attr_name, placeholder in [
            ...
            ctk.CTkLabel(left_frame, text=label_text, font=ctk.CTkFont(size=11)).pack(anchor="w", padx=15, pady=(10, 2))
            entry = ctk.CTkEntry(left_frame, placeholder_text=placeholder, height=30)
            entry.pack(fill="x", padx=15, pady=2)
            setattr(self, attr_name, entry)
        
        ctk.CTkLabel(left_frame, text="Message (max 8KB):", font=ctk.CTkFont(size=11)).pack(anchor="w", padx=15, pady=(10, 2))
        self.message_text = ctk.CTkTextbox(left_frame, height=100)
        ...
        ctk.CTkButton(btn_frame, text="Load XSS Test", command=self.load_xss_test,
                     height=30, width=120, fg_color="#FF5722").pack(side="left", padx=5)
        ctk.CTkButton(btn_frame, text="Clear", command=self.clear_form,
                     height=30, width=80).pack(side="left", padx=5)
        
        # Right: results
        right_frame = ctk.CTkFrame(container)
        right_frame.pack(side="right", fill="both", expand=True, padx=(10, 0))
        
        ctk.CTkLabel(right_frame, text="Validation Results", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=10)
        
        self.status_label = ctk.CTkLabel(right_frame, text="Status: Not validated", 
                                        font=ctk.CTkFont(size=12, weight="bold"))
        self.status_label.pack(pady=5)
        
        self.results_text = ctk.CTkTextbox(right_frame, height=400, font=ctk.CTkFont(size=11))
    ...
    def validate_form(self):
        ...
        self.status_label.configure(
            text="✓ Valid" if result['is_valid'] else "✗ Invalid",
            text_color="#4CAF50" if result['is_valid'] else "#F44336"
        )
    ...
    def clear_form(self):
        ...
        self.results_text.delete("1.0", "end")
        self.status_label.configure(text="Status: Not validated", text_color=("gray60", "gray40"))
...
class ResultsExportFrame(ctk.CTkFrame):
    ...
    def setup_ui(self):
        title = ctk.CTkLabel(self, text="Results & Export", 
                           font=ctk.CTkFont(size=24, weight="bold"))
        title.pack(pady=30)
        ...
        ctk.CTkButton(btn_frame, text="Export to CSV", command=self.export_csv,
                     width=150, height=40).pack(pady=10)
...
class HelpAboutDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent):
        ...
        title = ctk.CTkLabel(self, text="Security Toolkit Help", 
                           font=ctk.CTkFont(size=20, weight="bold"))
        title.pack(pady=20)
        
        help_text = ctk.CTkTextbox(self, width=550, height=350, font=ctk.CTkFont(size=11))
...
• Password Generator & Hasher:
  ...
  - Multiple password hashing: Each password hashed separately
    ...
    def setup_ui(self):
        ...
        for i, tool in enumerate(tools, 1):
            btn = ctk.CTkButton(self.sidebar, text=tool, 
                               ...
                               width=200, height=45, font=ctk.CTkFont(size=13))
        ...
        help_btn = ctk.CTkButton(self.sidebar, text="Help & About", 
                                ...
                                width=200, height=35, fg_color="gray30")
        ...
        self.frames["Local Security"] = LocalSecurityFrame(self.content_frame)
        self.frames["Web Security"] = WebSecurityFrame(self.content_frame)
        self.frames["Results & Export"] = ResultsExportFrame(self.content_frame, self)
